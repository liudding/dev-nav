...
const Card = ({ card, ...props }) => {
    ...
    return (<React.Fragment>
        <div className="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 cursor-pointer" style={{ width: 250 }}>
            <div className="logo flex justify-between items-center">
                {/* <Img fluid={featuredImgFluid} style={{ width: 40, height: 40 }} /> */}

                <div style={{ width: 40, height: 40 }} className="flex flex-col justify-around items-center bg-gray-100 rounded-full text-center">
            ...
            <div className="excerpt mt-4 text-xs text-gray-500 line-clamp-3">{card.desc}</div>

...
import { Box as BoxIcon, Menu as MenuIcon, X as CloseIcon } from "react-feather"
          ...
          <div class="flex items-center">
            ...
            <div class="flex justify-between items-center">
              <a href="https://flowbite.com" class="flex items-center">
                ...
                <span class="ml-3 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">DevNav</span>
              </a>
            </div>
            <Search></Search>
          </div>
          <div class="flex items-center">
            <a href="https://github.com/liudding/dev-nav" data-tooltip-target="tooltip-github-2" class="hidden sm:inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1">

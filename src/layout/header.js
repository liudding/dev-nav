    ...
    <React.Fragment>
      ...
      <header className="flex sticky top-0 z-40 flex-none py-3 mx-auto w-full bg-white border-b border-gray-200 dark:border-gray-600 dark:bg-gray-800">
        <div className="flex justify-between items-center px-3 mx-auto w-full max-w-8xl lg:px-4">
          ...
          <div className="flex items-center">
            <a href="https://github.com/liudding/dev-nav" data-tooltip-target="tooltip-github-2" className="hidden sm:inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1">
